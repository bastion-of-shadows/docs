...
purge_if_old_file () {
	newname=$(echo $1 | sed 's/\/bastionofshadows.com\/public\//\/build\//')
...
currentfiles=($(find ~/bastionofshadows.com/public -type f -print0 | xargs -0 ls | tr '\n' ' '))
